...
# Tarih: 29.12.2025
# Senaryo: Replay (Tekrar Oynatma) Saldırısı
...
async def execute_logic(cp):
    ...
    if await cp.send_authorize(ID_TAG_VICTIM) == AuthorizationStatus.accepted:
        ...
        logging.info("✅ Normal işlem bitti. Sniffing (Dinleme) yapılıyor...\n")
    
    # 2. SALDIRI (REPLAY)
    await asyncio.sleep(3)
    logging.info("💀 [SALDIRI] Replay Attack: Yakalanan paket tekrar gönderiliyor!")
